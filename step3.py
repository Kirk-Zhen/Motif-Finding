...
def plot_graphs(run_time_dict, entropy_dict, overlapped_dict):
    ...
    plot_a_graph(keys_icpc, run_time_dict, entropy_dict, overlapped_dict, label_icpc, fn="Impact_ICPC.png")
    plot_a_graph(keys_ml, run_time_dict, entropy_dict, overlapped_dict, label_ml, fn="Impact_ML.png")
    plot_a_graph(keys_sc, run_time_dict, entropy_dict, overlapped_dict, label_sc, fn="Impact_SC.png")
...
def main(args):
    ...
    plot_graphs(run_time_dict, entropy_dict, overlapped_dict)
