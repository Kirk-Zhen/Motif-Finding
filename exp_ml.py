...
def plot_graphs(run_time_dict, entropy_dict, overlapped_dict, algor):
    combinations = ["ml_6", "ml_7", "ml_8"]
    label_sc = ['ML-6', 'ML-7', 'ML-8']
    keys_sc =  ["ml_6", "ml_7", "ml_8"]
    ...
    plot_a_graph(keys_sc, run_time_dict, entropy_dict, overlapped_dict, label_sc, fn= f"ML_test_{algor}.png")
