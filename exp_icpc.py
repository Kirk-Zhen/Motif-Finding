...
def plot_graphs(run_time_dict, entropy_dict, overlapped_dict, algor):
    combinations = ["icpc_1", "icpc_15", "icpc_2"]
    label_sc = ['ML-1', 'ML-1.5', 'ML-2']
    keys_sc =  ["icpc_1", "icpc_15", "icpc_2"]
    ...
    plot_a_graph(keys_sc, run_time_dict, entropy_dict, overlapped_dict, label_sc, fn= f"ICPC_test_{algor}.png")
